<div class="modal fade" id="editarProveedor<?php echo $row[
    'id'
                ...
                <form action="../controllers/Proveedores.php" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-mdp-6">
                            ...
                            <input type="email" class="form-control" name="datos[]" value="<?php echo $row[
                                'email'
                            ]; ?>" id="inputCity">
                        </div>
                        <div class="form-group col-mdp-6">
                            <label for="inputCity">Télefono</label>
                            <input type="tel" class="form-control" name="datos[]" value="<?php echo $row[
                                'telefono'
                            ]; ?>" id="inputCity">
                        </div>
                    </div>
